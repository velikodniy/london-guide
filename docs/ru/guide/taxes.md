...
В остальных случаях **настоятельно рекомендуется открыть** [**ISA**](/ru/guide/stocks). Доходы, полученные через ISA не облагаются налогом.
...
Налоги на доходы не платятся вообще, если они получены при торговле со счёта [ISA](/ru/guide/stocks).
