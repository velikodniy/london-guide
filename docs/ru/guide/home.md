...
Убедитесь, что в соглашении упоминается [break clause](https://england.shelter.org.uk/housing_advice/private_renting/how_to_end_a_tenancy/ending_a_fixed_term_tenancy_early). Break clause нужен не всем, но если вы не знаете, что это или сомневаетесь, то лучше его добавить.
...
Если вы переехали, то как можно скорее настройте [перенаправление почты](/ru/guide/communication) (лучше это сделать до переезда) и сообщите об изменении адреса.
