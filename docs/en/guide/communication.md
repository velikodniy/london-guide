...
If you've moved and haven't had time to notify your correspondents of your new address, letters will continue arriving at the old address for a while. You probably won't have access to them, so immediately set up [mail forwarding](https://www.royalmail.com/personal/receiving-mail/redirection). You can set up forwarding for the whole family for up to one year.
...
- Within the UK — Royal Mail (they can come and collect), Hermes, DPD, ...
- To the USA — Pack&Send
- DHL and DHL Express (these are different things!)
...
| [Voxi](https://www.voxi.co.uk/plans) | Virtual operator owned by Vodafone and running on their network. Features a wide range of additional services.                                                                                                                   |                                                                                                                                                                                                                   |

Check what's best for you on [uSwitch](https://www.uswitch.com/mobiles/).\
In any case, you can quickly and freely [switch](https://www.ofcom.org.uk/phones-telecoms-and-internet/advice-for-consumers/costs-and-billing/text-to-switch) between operators while keeping your number.
...
If you have a TV at home, watch TV programs or live broadcasts via internet (whether British channels or just internet broadcasts of even foreign channels), or use BBC iPlayer, you must buy a [TV License](https://www.gov.uk/tv-licence).\
...
You don't need a license if there's no TV at home or you have paperwork from a service center that the TV's ability to receive broadcast signals has been disabled. However, you need to notify authorities that you're opting out. This can be done online on a [special website](https://www.tvlicensing.co.uk/).\
