...
See [frequently asked questions about NHS](https://www.kommersant.uk/articles/15-voprosov-o-britanskoy-natsionalnoy-sisteme-zdravoohraneniya-nhs-otvety-na-kotorye-vazhno-znat%20).
...
* If something is **relatively urgent but not dangerous**, you can call 111 or request a callback on [https://111.nhs.uk](https://111.nhs.uk). This is medical consultation. They'll reassure you, give advice, and tell you what to do next. They may direct you to the nearest clinic. During non-working hours, you'll wait longer for an answer. If you requested a call but missed it, they'll call again later (they might call in the middle of the night if you called in the evening).

  Example: severe headache making work impossible.
* If something is **urgent, needs a doctor, but not dangerous**. You can go to the nearest Walk-in centre (or A&E if there's no Walk-in centre nearby). Find the nearest one [on the NHS website](https://www.nhs.uk/Service-Search/other-services/Walk-in%20centre/LocationSearch/663) or call 111. They'll tell you where to go and forward your details to that center to save time. No appointment needed.

  Example: deep wound needing stitches.
* **Urgent and serious**. Then go to A&E or take a taxi. The main thing is to get there fast. Ambulances only come for life-threatening cases, so better to rely on yourself. The difference from Walk-in is that these are more advanced centers that can handle more problems, so there are fewer of them. Better to scout out the [nearest one](https://www.nhs.uk/Service-Search/other-services/Accident%20and%20emergency%20services/LocationSearch/428) in advance.
...
**Make sure to register with a GP (**[**by residence**](https://www.nhs.uk/service-search/find-a-gp)**, or online with services like** **GP at Hand**).** Note that registration takes some time.
...
Find the nearest medical facility (not just GP) [on the NHS website](https://www.nhs.uk/service-search).

## NHS Website

[**The NHS website**](https://www.nhs.uk/) **is a valuable source of medical information.** Here you can find information about various illnesses and learn whether you should see a doctor and how to treat yourself. Everything is written in simple, understandable language.

NHS also has a [mobile app.](https://www.nhs.uk/using-the-nhs/nhs-services/the-nhs-app/)
...
The [UK vaccination schedule](https://www.nhs.uk/conditions/vaccinations/nhs-vaccinations-and-when-to-have-them/) may differ from schedules in other countries. So if you've arrived with a child, register for vaccination at your GP. They'll ask for a list of vaccinations already done. You can just compile a list with dates in English and bring it. The nurse will check a special table to see which ones are needed and which can be skipped.
...
If you prefer the Soviet medical school, you can visit [Baltic Medical Centre](https://balticmedicalcentre.co.uk/home-ru-RU) at Canary Wharf. They have a GP, pediatrician, gynecologist, and the center can do tests on-site. Another clinic with Russian-speaking doctors is [PolyClinica No. 1](http://www.polyclinica.com/).
...
1. Contact the insurance company and describe your problem. The insurer checks if the case falls under the policy and asks for a GP referral.
2. See your GP or a doctor provided by the insurance company. You must tell your GP it's for insurance, otherwise they may not give a referral if they consider treatment unnecessary.
3. Pass the referral to the insurance company, and they'll give addresses of clinics where you can receive the required service.

Read more about booking private doctors in the article ["This Is a Diagnosis: How to Get Medical Examination in Britain"](https://telegra.ph/EHto-diagnoz-kak-popast-na-medicinskoe-obsledovanie-v-Britanii-09-08).
...
If you need a Russian-speaking dentist, many recommend [321 Dental](https://www.321dental.co.uk/) and [City Smile](http://www.citysmile.co.uk/) (actually the dentists are the same at both).
...
## How to Speak with a Doctor If Your English Isn't Great?
...
* **111 — medical consultation** if you feel unwell, or go to [https://111.nhs.uk](https://111.nhs.uk), but they'll call you back anyway. Call here if you don't know what to do.
* **999 — call if there's a threat to life**.
...
## If a Squirrel or Fox Bites You
